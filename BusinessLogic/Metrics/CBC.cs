...
namespace master_project.BusinessLogic.Metrics
{
    public class CBC
    {
        ...
        public CBC(List<UMLElement> diagramElements, string elementRef, string sDiagramElements)
        {
        ...
        {
            DAC cbc =new DAC(_diagramElements,_elementRef,_sDiagramElements);
            
            NASC nacs = new NASC(_diagramElements, _elementRef, _sDiagramElements);
            double result = nacs.Evaluate()+cbc.Evaluate();
